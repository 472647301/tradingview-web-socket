...
var UDFCompatibleDatafeedBase = /** @class */ (function () {
    function UDFCompatibleDatafeedBase(datafeedURL, quotesProvider, requester, updateFrequency, options) {
        var _this = this;
    ...
    UDFCompatibleDatafeedBase.prototype.changeBarsData = function (data) {
        this.barsData = data.bars;
        this.status = 1 /* COMPLETE */;
    };
    UDFCompatibleDatafeedBase.prototype.updateData = function (data) {
        this._dataPulseProvider._updateData(data);
    };
    /**
   * 异步延迟等待
   */
    UDFCompatibleDatafeedBase.prototype.delayAwait = function () {
        var _this = this;
    ...
    UDFCompatibleDatafeedBase.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate, onResult, onError) {
        var _this = this;
        if (this.options && this.options.getBars) {
            this.options.getBars(symbolInfo, resolution, rangeStartDate, rangeEndDate);
        }
        if (this.status === 1 /* COMPLETE */) {
            this.status = 0 /* LOADING */;
        }
        this.delayAwait()
