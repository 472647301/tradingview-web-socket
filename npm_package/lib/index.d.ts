...
export declare type OrderDialogCustomField =
...
export interface ChartingLibraryWidgetOptions {
  ...
  custom_indicators_getter?: (
    PineJS: PineJS
  ) => Promise<ReadonlyArray<CustomIndicator>>;
}
...
export interface IBrokerConnectionAdapterHost {
  ...
  showPositionBracketsDialog(
    ...
    handler: (brackets: Brackets) => Promise<void>
  ): Promise<void>;
  showNotification(
    title: string,
    text: string,
