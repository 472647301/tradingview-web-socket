...
export class UDFCompatibleDatafeedBase implements IExternalDatafeed, IDatafeedQuotesApi, IDatafeedChartApi {
	...
	protected constructor(datafeedURL: string, quotesProvider: IQuotesProvider, requester: Requester, updateFrequency: number = 10 * 1000, options: Options) {
   ...
   */
	public delayAwait(): Promise<any> {
		return new Promise((resolve, reject) => {
			this.awaitCount++
			logMessage(`UdfCompatibleDatafeed: Await count:: ${this.awaitCount * 300}ms`);
